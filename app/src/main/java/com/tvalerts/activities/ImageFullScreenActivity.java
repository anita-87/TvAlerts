...
public class ImageFullScreenActivity extends AppCompatActivity {
    ...
    private final Runnable mShowPart2Runnable = new Runnable() {
        ...
        public void run() {
            ...
            if (actionBar != null) {
                actionBar.setTitle(cast.getPerson().getName());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContentView = findViewById(R.id.iv_full_screen_image);
        ...
        this.cast = Parcels.unwrap(getIntent().getParcelableExtra(ARG_CAST));
        Log.d(TAG, "Cast is: " + this.cast.getPerson().getName());
        this.loadImage();
    }
